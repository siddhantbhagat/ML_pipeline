...
FILE_NAME = "MatNavi Mechanical properties of low-alloy steels.csv"
...
class DataIngestionConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        try:
            self.database_name="properties"
            self.collection_name="alloyproperties"
...
class DataValidationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.base_file_path = os.path.join('notebooks',"MatNavi Mechanical properties of low-alloy steels.csv")
